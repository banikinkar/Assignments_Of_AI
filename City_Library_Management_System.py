...
#    For Sample data insertion for output

def sample_run_script():
    print("=== Sample data inserting Script ===")
    print(" Add sample books")
    b1 = add_book("Bhagat Singh", "Rohit", "History")
    b2 = add_book("Modern India", "Saikat Mehrul", "Philosophy")
    b3 = add_book("Arranged Marriage", "Chetan Bhagat", "fantasy")
    print(f"  Added books: {b1}, {b2}, {b3}")
    print_books([books[b1], books[b2], books[b3]])
    print("\n Register members")
    m1 = register_member("Kousthuban", 50, "kousthub@gmail.com")
    m2 = register_member("Swapna", 22, "swapna@yahoo.com")
    ...
    print("  Search 'Rohit':")
    print_books(search_books_by_title_or_author("Rohit"))
    ...
    for k, v in library_summary().items():
        print(f"   {k}: {v}")
    print("\n Save data to 'sample_output.json'")
